# -*- coding: utf-8 -*-
"""
Created on Mon Nov 18 13:23:06 2024
...
output_directory = r"C:\\Users\\hwsimu01\\Documents\\mg2si_structures"
...
for fx in range(50, 160, 10):  # Factors from 0.5 to 1.5 in steps of 0.1
    for fy in range(50, 160, 10):
        for fz in range(50, 160, 10):
            ...
            filename = os.path.join(output_directory, f'mg2si_supercell_{fractional_modifier_x:.2f}_{fractional_modifier_y:.2f}_{fractional_modifier_z:.2f}.cif')
            supercell.write(filename)
